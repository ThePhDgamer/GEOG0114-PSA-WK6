...
**OBJECTIVES**: The US Environmental Agency have positioned air quality monitors for surveillance of over 100 different types of pollutants that exist as toxic gases, particulates and heavy metals. For **Sulphur Dioxide** ($SO_{2}$), there are 458 active air 
...
Using geostatistical methods and taking into account of car usage - what areas in USA have higher concentrations of $SO_{2}$ exceeding the annual average of 40 ppb which is a national safety limit for cause of concern?
